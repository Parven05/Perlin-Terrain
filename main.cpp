...
int main(void)
{
    ...
    while (!WindowShouldClose())
    {
        ...
        // ImGui::SliderInt("Min Amplitude", &minAmplitude , 60, 80);
        // ImGui::SliderInt("Max Amplitude", &maxAmplitude, 100, 180);

       /* ImGui::Spacing();
         ImGui::Text("Scroll Speeds");
         ImGui::Separator();

        ImGui::DragFloat("Scroll X", &scrollSpeedX, 0.01f);
        ImGui::DragFloat("Scroll Y", &scrollSpeedY, 0.01f);
